...
;
	...
	CP	IDEMODE_GIDE		; TEST FOR MODE
        LD	DE,IDE_STR_MODE_Z8B	; MODE LABEL
	CP	IDEMODE_Z8B		; TEST FOR MODE
	JR	Z,IDE_INIT2A		; IF SO, DISPLAY IT
...
; SOFT RESET
;
; RC AND Z8B CANNOT ACCESS DEVICE CONTROL REG, SO SKIP THIS
;
IDE_RESET2:
	LD	A,(IY+IDE_MODE)		; GET MODE
	CP	IDEMODE_RC		; RCBUS?
	JR	Z,IDE_RESET4		; IF SO, BYPASS
        CP	IDEMODE_Z8B		; ZEAL 8-BIT?
	JR	Z,IDE_RESET4		; IF SO, BYPASS
;
;
	; INITIATE SOFT RESET
