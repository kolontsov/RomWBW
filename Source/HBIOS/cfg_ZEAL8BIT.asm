...
ROMSIZE		.SET	512		; SIZE OF ROM IN KB (MUST MATCH YOUR HARDWARE!!!)
                                        ; FIRST 16KB OF ROM IS USED BY BOOTLOAD
                                        ; NEXT 48K IS RESERVED FOR ZEAL 8-BIT OS
...
Z8B_MMU_PAGE1   .SET    $F1             ; ZEAL8BIT BANK0 PAGE SELECT REG
Z8B_MMU_PAGE2   .SET    $F2             ; ZEAL8BIT BANK0 PAGE SELECT REG
Z8B_MMU_PAGE3   .SET    $F3             ; ZEAL8BIT BANK0 PAGE SELECT REG
;
