;
;==================================================================================================
;   ROMWBW PLATFORM CONFIGURATION DEFAULTS FOR PLATFORM: ZEAL8BIT
;==================================================================================================
;
...
;
#DEFINE PLATFORM_NAME	"Zeal 8-bit", " [", CONFIG, "]"	; TEXT LABEL OF THIS CONFIG IN STARTUP MESSAGES
...
;
PLATFORM	.SET	PLT_ZEAL8BIT	; PLT_[SBC|ZETA|ZETA2|N8|MK4|UNA|RCZ80|RCEZ80|RCZ180|EZZ80|SCZ180|GMZ180|DYNO|RCZ280|MBC|RPH|Z80RETRO|S100|DUO|HEATH|EPITX|MON|STDZ180|NABU|FZ80|ZEAL8BIT]
...
;
RAMSIZE		.SET	512		; SIZE OF RAM IN KB
ROMSIZE		.SET	512             ; SIZE OF ROM IN KB (MUST MATCH YOUR HARDWARE!!!)
APP_BNKS	.SET	$FF		; BANKS TO RESERVE FOR APP USE ($FF FOR AUTO SIZING)
MEMMGR		.SET	MM_Z8B          ; MEMORY MANAGER: MM_[SBC|Z2|N8|Z180|Z280|MBC|RPH|MON|EZ512|Z8B]
Z8B_MMU_PAGE0   .SET    $F0             ; ZEAL8BIT: BANK0 PAGE SELECT REG
Z8B_MMU_PAGE1   .SET    $F1             ; ZEAL8BIT: BANK1 PAGE SELECT REG
Z8B_MMU_PAGE2   .SET    $F2             ; ZEAL8BIT: BANK2 PAGE SELECT REG
Z8B_MMU_PAGE3   .SET    $F3             ; ZEAL8BIT: BANK3 PAGE SELECT REG
Z8B_ROM_START   .SET    $0              ; ZEAL8BIT: OFFSET OF ROMWBW IN ROM, ALIGNED BY 16K
                                        ; ($10000 AS EXAMPLE) TO COEXIST WITH ZEAL BOOTLOADER.
;
RTCIO		.SET	$10		; RTC LATCH REGISTER ADR
                                        ; ZEAL USES I2C RTC, ROMWBW DOESNT SUPPORT IT YET,
                                        ; BUT EVEN WITH RTC DRIVER DISABLED, HBIOS WILL
                                        ; DO 2 OCCASIONAL WRITES TO THIS REGISTER - SO IT'S
...
ZVBENABLE       .SET    TRUE            ; ZVB: ENABLE ZEAL 8-BIT VIDEO BOARD (ZVB.ASM)
;
...
IDETRACE        .SET    1               ; IDE: TRACE LEVEL (0=NO,1=ERRORS,2=ALL,3=REGS)
IDECNT          .SET    1               ; IDE: NUMBER OF IDE INTERFACES TO DETECT (1-3), 2 DRIVES EACH
IDE0MODE        .SET    IDEMODE_Z8B     ; IDE 0: DRIVER MODE: IDEMODE_[DIO|DIDE|MK4|RC|GIDE|Z8B]
IDE0BASE        .SET    $70             ; IDE 0: IO BASE ADDRESS
