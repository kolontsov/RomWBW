...
#IF (MEMMGR == MM_Z8B)
        ADD     A,A                     ; MULTIPLY BY 2 FOR 16K PAGE
        JR      NC,HBX_ROM              ; IF BIT 7 WASN'T SET, IT'S ROM
        ADD     A,$80000>>14            ; ADD RAM FIRST PAGE INDEX
        JR      HBX_BANKSEL
HBX_ROM:
        ADD     A,Z8B_ROM_START>>14     ; ADD ROM FIRST PAGE INDEX
HBX_BANKSEL:
...
#IF (MEMMGR == MM_Z8B)
  #IFDEF ROMBOOT
	; IF THIS IS A ROM BOOT, SETUP THE FIRST 2 16K MMU REGISTERS
	; TO MAP THE PROPER 32K OF PHYSICAL ROM TO THE LOW 32K OF
	; CPU ADDRESS SPACE (BANKING AREA).
        LD      A,Z8B_ROM_START>>14
	OUT	(Z8B_MMU_PAGE0),A       ; BANK_0: 0K - 16K
        INC     A
	OUT	(Z8B_MMU_PAGE1),A       ; BANK_1: 16K - 32K
  #ENDIF
