...
IDEMODE_Z8B     .EQU    6               ; ZEAL 8-BIT MODULE (8 BIT ONLY)
;
...
KBDMODE_ZVB     .EQU    4               ; ZEAL 8-BIT KEYBOARD CONTROLLER
;
...
#IF (BIOS == BIOS_WBW)
  ...
  #ENDIF
  #IF (MEMMGR == MM_Z8B)
	SYSECHO	"ZEAL 8-BIT ONBOARD (Z8B)"
  #ENDIF
  #IF (MEMMGR == MM_MON)
